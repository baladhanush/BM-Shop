          ...
          <div className="sm:col-span-2 py-10 pl-5 bg-gradient-to-br from-gray-400/90 to-gray-100 text-white rounded-3xl relative h-[320px] flex items-end">
            <div>
              <div className="mb-4">
                ...
                <a href="https://www.playstation.com/en-in/ps5/" target="_blank" rel="noopener noreferrer">
                <Button
                  text="Browse"
                  bgColor={"bg-primary"}
          ...
          <div className="py-10 pl-5 bg-gradient-to-br from-brandGreen/90 to-brandGreen/90 text-white rounded-3xl relative h-[320px] flex items-start">
            <div>
              <div className="mb-4">
                ...
                <a href="https://irusu.co.in/product-category/vr-headsets/" target="_blank" rel="noopener noreferrer">
                <Button
                  text="Browse"
                  bgColor={"bg-white"}
          ...
          <div className="py-10 pl-5 bg-gradient-to-br from-brandBlue to-brandBlue/90 text-white rounded-3xl relative h-[320px] flex items-start">
            <div>
              <div className="mb-4">
                ...
                <a href="https://www.portronics.com/collections/portable-speakers" target="_blank" rel="noopener noreferrer">
                <Button
                  text="Browse"
                  bgColor={"bg-white"}
