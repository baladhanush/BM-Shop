        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="py-10 pl-5 bg-gradient-to-br from-black/90 to-black/70 text-white rounded-3xl relative h-[320px] flex items-end">
            <div>
              ...
              <a href="https://www.croma.com/audio-video/headphones-earphones/c/1012" target="_blank" rel="noopener noreferrer">
                <Button
                  text="Browse"
                  bgColor={"bg-primary"}
          ...
          <div className="py-10 pl-5 bg-gradient-to-br from-brandYellow to-brandYellow/90 text-white rounded-3xl relative h-[320px] flex items-end">
            <div>
              ...
              <a href="https://www.fastrack.in/shop/watches" target="_blank" rel="noopener noreferrer">
                <Button
                  text="Browse"
                  bgColor={"bg-white"}
          ...
          <div className="sm:col-span-2 py-10 pl-5 bg-gradient-to-br from-primary to-primary/90 text-white rounded-3xl relative h-[320px] flex items-end">
            <div>
              <div className="mb-4">
                ...
                <a href="https://www.croma.com/computers-tablets/laptops/c/20" target="_blank" rel="noopener noreferrer">
                <Button
                  text="Browse"
                  bgColor={"bg-white"}
